...
fun WelcomeScreen(viewModel: com.example.ui.SocialViewModel, modifier: Modifier = Modifier) {
    ...
    val greeting = when (hour) {
        in 0..5 -> listOf(
            "Доброй ночи", "Ночной хаос", "Спи давай", "Кибер-ночь", "Не спишь?", 
            "Темнота – друг молодежи", "Время для рефакторинга", "Время багов", "Сладких снов", 
            "Энергетик кончился?", "Питерская ночь", "Пора спать", "Режим совы активирован", 
            "404 Сон не найден", "Никакого сна!", "Who needs sleep?", "Полуночный код", 
            "Ночная смена", "Силиконовые сны", "Шифрование во тьме", "Генератор бессонницы", 
            "Глубокий сон? Не слышал", "Тишина в эфире", "Луна над процессором", "Ночной дожор 🍕",
            "Опять компилируешь? ⌨️", "Сон для слабаков 🦾", "Матрица засыпает, просыпаются боты",
            "Короче, пора спать чел 💤", "Бля, иди спи, глаза выпадут 👀", "Прошивка ночи загружена 🌌",
            "Хули не спишь-то, бля? 🦉", "Чисто ночной задрот, уважение 🤝", "Ебать, три часа ночи, иди поспи реально",
            "Походу мозг уже плавится в темноте 🧠", "Сука, выключи монитор, утро скоро!", "Ночной жор активирован нахуй 🔋",
            "Слушай, ну спать же надо когда-то, не?", "Короче, полуночник, велкам в тред 👾"
        ).random()
        in 6..11 -> listOf(
            "Доброе утро", "Утро доброе", "Ку-ку", "Просыпайся", "Кофе готов?", 
            "Время гриндить", "С добрым утром!", "Восстань!", "Пора за дело", "Бодрое утро", 
            "Утренний чек", "Rise and shine", "Открываем глаза", "Ранняя пташка", "Утречко", 
            "Let's go", "Стартуем!", "Новый день – новый деплой", "Утренний чилл", "Проснись и пой", 
            "Кофеин в крови", "Запуск систем...", "Добрейшего утречка", "Утренний кофеин",
            "Ну типа с добрым утром! 🌅", "Короче, подъем, солнце уже высоко ☀️", "Рассвет кремния 🌱",
            "Чел, хорош дрыхнуть! ⏰", "Привет, крипто-сталкер 👋", "Новый день – новые баги 🐛",
            "Эй, ленивая жопа, вставай давай! ⏰", "С добрым утречком, разраб хуев ☕", "Ебать ты рано проснулся, че случилось?",
            "Чисто утречко под кружку кофе и свежие мемы 🍩", "Короче, вставай, на завод пора!", "Ну че, проснулся, сука-богатырь? 😄",
            "Опять утро, опять этот безумный мир 🌍", "Хули так рано-то вставать, ну ладно, привет 👋"
        ).random()
        in 12..16 -> listOf(
            "Добрый день", "Привет", "Приветствую", "Рабочий процесс", "Хеллоу", "Салют", 
            "Как успехи?", "В эфире", "Вливайся", "Как оно?", "День в самом разгаре", 
            "Не скучаем!", "Продуктивный день", "Связь установлена", "Готов к труду", 
            "Все идет по плану", "Work work work", "Кибер-полдень", "Обеденный перерыв", 
            "Как дела?", "На связи", "Энергичный полдень", "Прогрев процессора", "Всё под контролем",
            "Ну привет, легенда 🤝", "Как там твой баланс? 🪙", "Чел, ну как дела вообще? 🤔",
            "Собственно, добрый день! 🦾", "Погнали ревьюить 🚀", "Обед сам себя не съест 🌯",
            "Здорово, родной! Че по делам вообще? 🏎️", "Чисто рабочий полдень без напряга 💻", "Сука, ну и жара на улице, заходи посиди",
            "Короче, че каво? Как житуха? 😁", "Челик, здорово, какие новости в сети?", "Ебать, уже обед, а я еще ничего не сделал",
            "Ну привет, ебать-копать, как день проходит? 🛠️", "Реально, забей на работу, давай полистаем тред"
        ).random()
        else -> listOf(
            "Добрый вечер", "Вечер в хату", "Здравствуйте", "Уже стемнело", "Добрый", 
            "Привет-привет", "Отдыхаешь?", "Заходи, не бойся", "Удачи в ночи", "Хорошего вечера", 
            "Тусовочный вайб", "Вечерние новости", "Вечерний чилл", "Ламповый вечер", 
            "Пожалуй, отдохнем", "Что нового?", "Кибер-закат", "Вечерний релакс", "Разгрузка ядер", 
            "Ламповое время", "Завершение компиляции", "Оффлайн близко", "Приятного вечера",
            "Короче, evening в разгаре! 🍺", "Ну что, по пивку и в казино? 🎰", "Жесть, уже вечер 🌇",
            "Ору, ну и денек сегодня был 😂", "Чел, зацени вечерний вайб ✨", "Чисто ламповый релакс 🛋️",
            "Здорово, заебал! Че делаешь вечером? 🍻", "Вечер в хату, господа лудоманы 🎰", "Ебать, ну и денек, пора завалить ебало и чиллить",
            "Короче, вечер под пивас и кейсы — это святое 🍺", "Жесть походу, день пролетел нахуй!", "Реально лампово сидим, заходи попиздеть 🕯️",
            "Сука, наконец-то вечер, можно расслабить булки 🍩", "Че каво, бля? Че делаешь вообще? 👀", "Ну че, легенда, погнали катать в дурака? 🃏"
        ).random()
    }
